...
const section_class = "w-full sm:pt-[100px] pt-[412px] tbt:pt-0 tbt:h-[528px] bg-gradient-to-r from-Brand-Default-Primary/50 to-Brand-Default-Secondary/50 dsk:max-w-[1920px] dsk:mx-auto"
